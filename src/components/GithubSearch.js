...
export const GithubSearch = () => {
  ...
  return (
    <div className='main-container'>
        <h1 className='main-heading'>GitHub Profile Detector</h1>
                ...
                <div className='profile-content'>
                    ...
                    <div className='profile-details'>
                        ...
                        <div className='profile-info'>
                            ...
                            <p className='profile-company'><FaBuilding/>{profile.company}</p>
                        </div>
                        
                        <div className='profile-links'>
                        <a href="https://www.linkedin.com/in/meenakshi-marree-19699b276" target="_blank" rel="noreferrer" className='linkedin-link'>
                            <FaLinkedin /> meenakshi-marree</a>
